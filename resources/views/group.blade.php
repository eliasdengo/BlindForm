        ...
        <div class="col-lg-4">
          ...
          <div class="info-container d-flex flex-column align-items-center justify-content-center">
            ...
            <!-- Example single danger button -->
              ...
              <div class="btn-group info-item d-flex">
                <button type="button" id="dropTopic" class="btn  dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  Topic
                </button>
                ...
                @foreach ($topics as $topic)
                  ...
                  <li>
                    <a class="dropdown-item" href="/groupWild/{{$topic->id}}">{{$topic->topic}}</a>
                  </li>
                   @endforeach
                </ul>
              </div>
        ...
        <div class="col-lg-8">
          <form action="forms/contact.php" method="post" role="form" class="php-email-form">
            ...
            <div class="form-group mt-3">
              <textarea class="form-control" name="message" rows="15" enabled>
            ...
            <div class="columns">
              ...
              <div class="text-center">
                ...
                <button type="submit"><a href="#">End Message</a></button>
              </div>
